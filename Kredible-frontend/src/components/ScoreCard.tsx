...
export default  function ScoreCard() {
    ...
    return (
        <>
            <div className=' nft-bg w-[425px] h-[540px] mr-[100px] flex flex-col items-center  mb-[100px]'  >
                ...
                <div className=' flex flex-col w-[357px] mt-[40px]'>
                    <div className='flex'>
                        ...
                        <h2 className='text-[14px] ml-2 text-[#FF89E6]'>Get summary of your score</h2>
                    </div>
                    <div className='flex mt-2'>
                        <div className='w-[24px] h-[24px] bg-white-icon flex items-center justify-center rounded-md'>
                            <img src="Star 1.png" alt="" />
                        </div>
                        <h2 className='text-[14px] ml-2 text-[#FF89E6]'>
